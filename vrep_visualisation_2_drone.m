...
block.InputPort(6).Dimensions  = 4;
...
block.Dwork(2).Data=vrep.simxStart(block.DialogPrm(2).Data,19997,true,true,5000,5);
vrep.simxSynchronous(block.Dwork(2).Data,true);
vrep.simxSetFloatingParameter(block.Dwork(2).Data, vrep.sim_floatparam_simulation_time_step, block.DialogPrm(1).Data, vrep.simx_opmode_oneshot_wait);

%get ObjectHandles
[~, quad_base] = vrep.simxGetObjectHandle(block.Dwork(2).Data,'Quadricopter',vrep.simx_opmode_blocking);
[~, target] = vrep.simxGetObjectHandle(block.Dwork(2).Data,'Quadricopter_target',vrep.simx_opmode_blocking);
[~, quad_base2] = vrep.simxGetObjectHandle(block.Dwork(2).Data,'Quadricopter#0',vrep.simx_opmode_blocking);
[~, target2] = vrep.simxGetObjectHandle(block.Dwork(2).Data,'Quadricopter_target#0',vrep.simx_opmode_blocking);
...
block.Dwork(1).Data = [quad_base, target, quad_base2, target2]';
...
[~] = vrep.simxSetObjectPosition(block.Dwork(2).Data,block.Dwork(1).Data(2),-1,block.InputPort(1).Data,vrep.simx_opmode_oneshot);
[~] = vrep.simxSetObjectPosition(block.Dwork(2).Data,block.Dwork(1).Data(1),-1,block.InputPort(2).Data,vrep.simx_opmode_oneshot);
[~] = vrep.simxSetObjectQuaternion(block.Dwork(2).Data,block.Dwork(1).Data(1),-1,block.InputPort(3).Data,vrep.simx_opmode_oneshot);
[~] = vrep.simxSetObjectPosition(block.Dwork(2).Data,block.Dwork(1).Data(4),-1,block.InputPort(4).Data,vrep.simx_opmode_oneshot);
[~] = vrep.simxSetObjectPosition(block.Dwork(2).Data,block.Dwork(1).Data(3),-1,block.InputPort(5).Data,vrep.simx_opmode_oneshot);
[~] = vrep.simxSetObjectQuaternion(block.Dwork(2).Data,block.Dwork(1).Data(3),-1,block.InputPort(6).Data,vrep.simx_opmode_oneshot);
